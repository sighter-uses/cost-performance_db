...
// 下限は4度。0.5にしていたため、説明文に紛れた「2%」の類を度数として拾い、
// 純アルコール量が1/20に見積もられて、誤った最高額が単価ランキングの先頭に立っていた
// （グラッパが34,826円/20g、ブランデー16年が33,000円/20gとして掲載されていた）。
// 蒸留酒のジャンルに3度以下の商品は実在しない。5〜9度のジンソーダ等のRTDは実在するので残す。
const ABV_MIN = 4;
const ABV_MAX = 96;
